...
const breadbrums = [
    ...
    {
        title: "Reporte Horas por Servicios",
        disabled: false,
        url: "",
        name_url: "",
    },
...
const generarReporte = async () => {
    ...
    if (valid) {
        ...
        axios
            .get(route("reportes.rg_hora_servicios"), { params: form.value })
            .then((response) => {
                ...
                Highcharts.chart("container", {
                    ...
                    tooltip: {
                        ...
                        pointFormat:
                            '<span style="color:{point.color}">{point.name}</span>: <b>{point.y:.2f} h.</b><br/>',
                    },
...
const generarReportePdf = () => {
    generando.value = true;
    const url = route("reportes.r_hora_servicios", form.value);
...
<template>
    <Head title="Reporte Horas por Servicios"></Head>
    <v-container>
